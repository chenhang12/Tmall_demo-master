...
public class User {
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return Objects.equals(user_id, user.user_id) && Objects.equals(user_name, user.user_name) && Objects.equals(user_nickname, user.user_nickname) && Objects.equals(user_password, user.user_password) && Objects.equals(user_realname, user.user_realname) && Objects.equals(user_gender, user.user_gender) && Objects.equals(user_birthday, user.user_birthday) && Objects.equals(user_address, user.user_address) && Objects.equals(user_homeplace, user.user_homeplace) && Objects.equals(user_profile_picture_src, user.user_profile_picture_src) && Objects.equals(reviewList, user.reviewList) && Objects.equals(productOrderItemList, user.productOrderItemList) && Objects.equals(productOrderList, user.productOrderList);
    }

    @Override
    public int hashCode() {
        return Objects.hash(user_id, user_name, user_nickname, user_password, user_realname, user_gender, user_birthday, user_address, user_homeplace, user_profile_picture_src, reviewList, productOrderItemList, productOrderList);
    }
}
